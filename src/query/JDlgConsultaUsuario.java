...
public class JDlgConsultaUsuario extends javax.swing.JDialog {
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        ...
        if (jTxtNome.getText().equals("") && jTxtCpf.getText().equals("")){
            ...
            if (!jTxtNome.getText().equals("") && !jTxtCpf.getText().equals("")){
                List lista = usuarioDao.listaNomeCpf(jTxtNome.getText(), jTxtCpf.getText());
                usuarioControle.setList(lista);
            } else {
                if (!jTxtNome.getText().equals("")){
                    List lista = usuarioDao.listaNome(jTxtNome.getText());
                    usuarioControle.setList(lista);
                } else {
                    if (!jTxtCpf.getText().equals("")){
                        List lista = usuarioDao.listaCpf(jTxtCpf.getText());
                        usuarioControle.setList(lista);
                    } 
